...
var CommutResults = ({duration, normalizedScore, apiVar3, departureTime, departureGateDelayMinutes, departureRunwayDelayMinutes, arrivalGateDelayMinutes, arrivalRunwayDelayMinutes, departureTerminal, departureGate, arrivalTerminal, arrivalGate, precheck, WaitTime, LastUpdated}) => {
  return (
    <div>
